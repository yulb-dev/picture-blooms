...
class MainUserIsLogin extends Component {
    render() {
        const user = {
            ...this.props
        }
        return (
            <div className='myself-main'>
                ...
                <div className='other-information'>
                    <div onClick={this.show.bind(this, 'dynamic')}><h3>{user.dynamic.length}</h3><p>动态</p></div>
                    <div onClick={this.show.bind(this, 'idol')}><h3>{user.idol.length}</h3><p>关注</p></div>
                    <div onClick={this.show.bind(this, 'fans')}><h3>{user.fans.length}</h3><p>粉丝</p></div>
                </div>
...
export default MainUserIsLogin